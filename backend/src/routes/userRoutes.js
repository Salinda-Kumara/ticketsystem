...
router.post('/', roleGuard('ADMIN'), activityLogger('CREATE', 'User'), createUser);
router.put('/:id', roleGuard('ADMIN'), activityLogger('UPDATE', 'User'), updateUser);
router.delete('/:id', roleGuard('ADMIN'), activityLogger('DELETE', 'User'), deleteUser);
